<div class="innovationsslussen-layout-wrap" id="main-content" role="main">
		...
		<table class="portlet-layout">
			<tr>
				...
				<td class="aui-w20 portlet-column" id="column-3">
		...
		<div class="portlet-layout">
			<div class="aui-w60 portlet-column portlet-column-first" id="column-2">
				$processor.processColumn("column-2", "portlet-column-content portlet-column-content-first")
			</div>
			<div class="aui-w20 portlet-column" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content portlet-column-content-last")
			</div>
